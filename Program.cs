...
class Program
{
    // problem1 : the program class is dependent on the concrete classes of the meal components like ChickenSalad ...etc because it uses them directly using new keyword.
    // problem2 : the program class is not flexible to add or change new meal components because it uses switch case to handle the meal components.
    // problem4 : the meal details should be hidden from the user, but the program class is exposing the details of the meal components to the user.
    ...
    public static void Main(string[] args)
    {
        ...
        if (int.TryParse(Console.ReadLine(), out choice))
        {
            ...
            {
                case 5:
                    meal.MainDish = new Lasagna("Large", "300-600", 14.99m, new() { "Pasta", "Cheese", "Tomato", "Beef" });
                    break;
                case 6:
                    meal.MainDish = new Steak("Medium", "500-700", 17.99m, new() { "Beef steak", "Salt", "Pepper" });
                    break;
                case 7:
                    meal.MainDish = new Molokhiya("Medium", "100-200", 16.99m, new() { "Molokhiya leaves", "Chicken broth", "Garlic", "Coriander" });
                    break;
                case 8:
                    meal.MainDish = new GrilledChicken("Large", "200-300", 15.99m, new() { "Chicken", "Salt", "Pepper", "Paprika" });
                    break;
                default:
                    break;
            }
